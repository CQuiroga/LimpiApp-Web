...
class RutaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rutum" do
    assert_difference('Rutum.count') do
      post ruta_url, params: { rutum: { latitud: @rutum.latitud, longitud: @rutum.longitud, ruta: @rutum.ruta } }
    end
  ...
  test "should update rutum" do
    patch rutum_url(@rutum), params: { rutum: { latitud: @rutum.latitud, longitud: @rutum.longitud, ruta: @rutum.ruta } }
